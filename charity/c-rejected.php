...
// Count the total number of rejected donations
...
<head>
    ...
    <title>NEUKAI - Rejected Donations Summary</title>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                <div class="md:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="bg-white rounded-xl p-4 shadow border border-gray-100 flex items-center">
                        ...
                        <div>
                            <h2 class="text-sm text-gray-500 font-medium">Rejected Donations</h2>
                            <p class="text-2xl font-bold text-red-600"><?php echo $total_rejected; ?></p>
                        </div>
                    </div>
                        ...
                        if ($total_rejected > 0) {
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead>
                                        <tr class="bg-gray-50">
                                            ...
                                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rejected Date</th>
                                        </tr>
                                    </thead>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo '<tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-4 py-3 whitespace-nowrap text-sm">
                                            <a href="c-rejected_summary.php?transaction_id=' . $row['transaction_id'] . '"
                                        ...
                                        '</td>
                                        <td class="px-4 py-3 whitespace-nowrap text-sm">' . 
                                            htmlspecialchars($row['rejected_at']) . 
                                        '</td>
                                      </tr>';
                            }
                            ...
                            echo '<div class="text-center py-12 px-4">
                                    ...
                                    <p class="text-gray-500 max-w-md mx-auto">
                                        No donations rejected found for this charity.
                                    </p>
                                </div>';
                        }
