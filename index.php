    ...
    <main class="flex-grow">
        ...
        <div class="flex justify-center px-4">
            <div class="w-full max-w-[1300px] h-auto min-h-[600px] md:h-[2100px] bg-white rounded-3xl overflow-hidden">
                ...
                <!-- Sliding Images -->
                <div class="slideshow-container overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row justify-center items-center md:space-x-4 space-y-4 md:space-y-0 mt-4 px-4">
                    <div class="bg-white p-6 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.6)] w-[321px] h-[421px] text-center rounded-2xl flex flex-col justify-center items-center">
                ...
                <!-- Blue Card -->
                <div
                    class="relative w-full max-w-[1300px] h-[400px] mx-auto mt-10 flex items-center justify-between px-4 sm:px-12">
