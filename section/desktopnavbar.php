...
<div id="navbar"
    ...
    <div id="nav-links" class="hidden md:flex space-x-6 items-center">
        ...
        <a href="index.php#about" class="text-sm md:text-white hover:text-[#fbb801] transition duration-200">ABOUT</a>
        <a href="donor.php" class="hover:scale-105 transition-transform text-white duration-200">
